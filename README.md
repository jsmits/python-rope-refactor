...
Run `python scripts/rope_refactor.py --help` for the full command list.
...
## Rope setup (per project you refactor)

In the Python project you want to refactor:
...
```bash
python scripts/rope_refactor.py rename-symbol --help
python scripts/rope_refactor.py ... --dry-run
```
